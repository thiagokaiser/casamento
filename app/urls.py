...
urlpatterns = [
    ...
    url(r'^pagamento/(?P<pk>\d+)/cadastra/$', views.Pagamento_New , name='pagamento_new'),
    url(r'^pagamento/(?P<pk>\d+)/lista/$', views.Pagamento_List , name='pagamento_list'),
    ...
    url(r'^anexo/(?P<pk>\d+)/cadastra/$', views.Anexo_New , name='anexo_new'),
    url(r'^anexo/(?P<pk>\d+)/lista/$', views.Anexo_List , name='anexo_list'),
